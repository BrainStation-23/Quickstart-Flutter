...
import 'package:qs_flutter/core/base/widgets/app_header.dart';
...
import 'package:qs_flutter/features/sign_in/presentation/bloc/sign_in_selector.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print("i am calling from build method");
  ...
  Widget _buildSignInButton() {
    return SignInLoadingSelector((currentState) {
        ...
        ListTile(
          ...
          subtitle: Padding(
            ...
            child: AppTextField(
              ...
              onChanged: (value) {
                signInBloc.add(EmailChangeEvent(email: value.toString()));
              },
            ),
          ),
        );
