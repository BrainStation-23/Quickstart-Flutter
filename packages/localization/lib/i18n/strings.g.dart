...
///
/// Built on 2024-07-03 at 12:18 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	String hello({required Object n}) => 'hello ${n}';
}
...
class _StringsBn implements Translations {
	...
	@override String hello({required Object n}) => 'হ্যালো ${n}';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'hello': return ({required Object n}) => 'hello ${n}';
			default: return null;
		}
	}
}
...
extension on _StringsBn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'language': return 'বাংলা';
			case 'hello': return ({required Object n}) => 'হ্যালো ${n}';
			default: return null;
		}
	}
}
